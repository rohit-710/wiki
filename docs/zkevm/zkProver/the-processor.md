...
![Main SM's simplified state transition](figures/04msm-simple-state-transition.png)
...
![The addr register and its use in different contexts](figures/05msm-addr-reg-contexts.png)
